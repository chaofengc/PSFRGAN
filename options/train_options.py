...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--no_strict_load', action='store_true', help='continue training: load the latest model')
        parser.add_argument('--distributed', action='store_true', help='continue training: load the latest model')
        ...
        parser.add_argument('--vgg_layers', type=str, default='2,3,4', help='layers used to calculate vgg perceptual loss')
        parser.add_argument('--g_lr', type=float, default=0.0001, help='if specified, not use self-similarity feature')
        parser.add_argument('--d_lr', type=float, default=0.0004, help='if specified, not use self-similarity feature')
